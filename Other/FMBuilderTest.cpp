...
TEST_CASE("eshopModel with ignore", "[eshopModel1]") {
	Util::SORT_CONSTRAINTS_WHEN_APPLYING = false;
	// 2.2602e+49
	string nConfig = "22602043046884907138622062009629005242624813039616";
	string computedCfgs = Util::getProductCountFromFile(
...
TEST_CASE("violetModel without ignore", "[violetModel1]") {
	Util::SORT_CONSTRAINTS_WHEN_APPLYING = false;
	// 5.93843e+18
	string nConfig = "5938433009513149440";
	REQUIRE(
...
TEST_CASE("violetModel with ignore", "[violetModel2]") {
	Util::SORT_CONSTRAINTS_WHEN_APPLYING = false;
	// 3.89226e+18
	string nConfig = "3892263109263360000";
	string computedConfig = Util::getProductCountFromFile(
...
TEST_CASE("waterlooModel with ignore", "[waterlooModel1]") {
	Util::SORT_CONSTRAINTS_WHEN_APPLYING = false;
	// 6.70835e+101
	string nConfig = "670835392217916052367826961285705439055529026755794918488321216695556598191228298976523484421022547968";
	REQUIRE(
...
TEST_CASE("uClibCModel without ignore", "[uClibCModel1]") {
	Util::SORT_CONSTRAINTS_WHEN_APPLYING = false;
	// 1.66019e+40
	string nConfig = "16601881363009995393029846406265571377152";
	REQUIRE(
...
TEST_CASE("Embtoolkit without ignore", "[embToolkit1]") {
	Util::SORT_CONSTRAINTS_WHEN_APPLYING = false;
	// 5.13456e+96
	string nConfig = "5134555717728406502218134350650551212671101329005046085996988582713204660115755558759929862946816";
	REQUIRE(
